...
import { Zap, Layers, Flame, Waves, Cog, Wrench, Cpu, Clock, Award, BookOpen, TrendingUp, Target } from 'lucide-react';
import { mechanicalCurriculumService } from '../../services/mechanicalCurriculumService';
...
const MechanicalEngineeringCurriculum = () => {
  ...
  const loadCurriculumData = async () => {
    try {
      ...
      const [modulesData, skillTreeData, achievementsData, challengeData] = await Promise.all([
        mechanicalCurriculumService?.getMechanicalModules(userId),
        mechanicalCurriculumService?.getMechanicalSkillTree(userId),
        mechanicalCurriculumService?.getMechanicalAchievements(userId),
        mechanicalCurriculumService?.getTodayMechanicalChallenge(userId)
      ]);
  ...
  const handleStartLesson = async (lessonId) => {
    try {
      await mechanicalCurriculumService?.startLesson(userId, lessonId);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Mechanical Engineering Curriculum...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 mb-4">
                Master mechanical engineering from statics and dynamics to robotics and manufacturing
              </p>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-orange-600">1,890</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              {(() => {
                ...
                return nextModule ? (
                  <div 
                    className="p-4 border border-orange-200 rounded-lg cursor-pointer hover:bg-orange-50 transition-colors"
...
export default MechanicalEngineeringCurriculum;